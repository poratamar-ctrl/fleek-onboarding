...
// ---------- Icons ----------
export const Icon = ({ name, size = 18, style, className, ...rest }) => {
  const paths = {
...
// ---------- Starburst ----------
export const Starburst = ({ size = 24, color = 'var(--accent)', spin = false }) => (
  <svg
  ...
  >
    <path
      d="M50 2 L58 32 L88 18 L66 44 L98 50 L66 56 L88 82 L58 68 L50 98 L42 68 L12 82 L34 56 L2 50 L34 44 L12 18 L42 32 Z"
      fill={color}
    />
  </svg>
);
...
// ---------- Top chrome ----------
export const Chrome = ({ state, onHome, onOpenAssistant, crumbs = [] }) => {
  ...
  return (
    <header className="chrome">
      <div className="chrome-inner">
        ...
        >
          <Image src="/fleek-logo.png" alt="Fleek" width={78} height={26} className="brand-mark" style={{ height: 26, width: 'auto' }} />
...
// ---------- Toast ----------
export const Toast = ({ children, icon = 'check' }) => (
  <div className="toast">
...
// ---------- Reflection block ----------
export const Reflection = ({ prompt, value, onChange, onSubmit, shared, onShare, submitted }) => {
...
// ---------- Page wrapper ----------
export const Page = ({ children, max = 1100 }) => (
