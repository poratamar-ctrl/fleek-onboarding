...
export default function Hub({ state, profile, onOpenDay, onOpenAssistant, onHome }) {
...
function DayCard({ def, index, state, isComplete, isUnlocked, isCurrent, onOpen }) {
    ...
    >
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
          ...
          {isCurrent && <span className="mono" style={{ fontSize: 11, color: 'var(--accent)' }}>&larr; you are here</span>}
