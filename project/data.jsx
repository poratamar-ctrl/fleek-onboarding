// Mock data. People, tasks, scenarios, AI assistant responses.
const TEAMMATES = [
 {
 name: "Maya Patel",
...
const LEADERSHIP = [
 ...
 name: "Priya Balan",
 role: "VP People",
 bio: "Built People functions at two Series A→C startups. Joined Fleek because the problem is operationally huge and the team treats culture like product.",
...
// Mock AI assistant responses. Keyword-routed.
const ASSISTANT_RESPONSES = [
 ...
 text: "Comp specifics live in Rippling under your offer letter. Benefits doc is in Notion → People → London Benefits. For anything sensitive or off-record, Ayesha (your manager) is the right person. she'd rather you ask early than guess.",
 },
];
...
Object.assign(window, {
 TEAMMATES, LEADERSHIP, COFFEE_SPOTS, DAY_DEFS,
 ASSISTANT_RESPONSES, FALLBACK_RESPONSE, SUGGESTED_PROMPTS,
});
