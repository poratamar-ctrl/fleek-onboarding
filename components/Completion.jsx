...
import { DAY_DEFS } from '../data';
import { Icon, Chrome, Page } from './ui';

export default function Completion({ profile, state, onRestart, onOpenAssistant }) {
      ...
      <Page max={920}>
        ...
        >
          ...
          <motion.div
            ...
            className="eyebrow"
            style={{ marginTop: 32, marginBottom: 16, color: 'var(--accent)' }}
          >
            Week one complete
          </motion.div>
          <motion.h1
          ...
          <motion.p
            ...
            style={{ color: 'var(--text-2)', fontSize: 17, lineHeight: 1.6, margin: '0 auto', maxWidth: 540 }}
          >
    ...
    <div style={{ position: 'relative', height: 80, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 14 }}>
        {[0, 1, 2, 3, 4].map((i) => (
          <span
            key={i}
            className="status-dot status-done"
            style={{
              width: 12, height: 12,
